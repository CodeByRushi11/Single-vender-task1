    ...
    >
      <div className="w-[400px] mx-auto my-[10rem] p-[50px] bg-white rounded-[10px] shadow-[0_0_15px_rgba(0,0,0,0.1)]">
        ...
        <p className="pb-[30px] text-[12px] leading-[20px] align-middle font-normal font-jost ">
          No worries! Enter your email address below and we will send you code
          to reset password
        </p>
        <input
          className="w-full  px-[12px] py-[10px] rounded-md text-[14px] bg-[#f2f3f5] outline-none mb-[30px]
"
          type="email"
        ...
        />
        <Link to="/CheckEmail" state={{ email }}>
          {" "}
